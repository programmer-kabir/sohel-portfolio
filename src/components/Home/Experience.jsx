  ...
  return (
    ...
    >
      ...
      <Container>
        <div className="pt-12">
          <div
            className="md:flex items-center gap-5 px-6 py-8 rounded-lg"
            style={{
          ...
          >
            ...
            <div className="pt-5 md:pt-0">
              ...
              >
                ...
                <p style={{fontFamily: "Poppins, sans-serif"}}>
                  5. Delivered UI designs to both local and international
                  clients through Fiverr and direct collaborations
                </p>
              </div>
            </div>
          </div>
